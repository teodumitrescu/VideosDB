...
public final class Constants {
    ...
    public static final int YEAR_FILTER_POS = 0;
    public static final int GENRE_FILTER_POS = 1;
    public static final int WORDS_FILTER_POS = 2;
    public static final int AWARD_FILTER_POS = 3;
}
